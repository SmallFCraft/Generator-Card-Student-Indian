...
export const generateStudentData = async (): Promise<GeneratedStudentData> => {
  ...
  const prompt = `Create sample student information for an educational database. Generate the following data:

Student Information:
- Full Name: Create an Indian name with first and last name
- Father's Full Name: Create a different Indian name for the father
- Mobile Number: Format as +91 followed by 10 digits (starting with 6, 7, 8, or 9)
- Academic Batch: Select from these options: ${validBatchYears.join(', ')}
...
Example names: Arjun Sharma, Priya Patel, Vikram Singh, Anita Gupta
Example mobile: +91 9876543210
Example batch: 2024-2028
